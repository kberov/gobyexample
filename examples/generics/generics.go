...
// [^type_p]: type parameter – податка за очакван вид данни, параметър за тип

package main

import "fmt"

// `SlicesIndex` е пример за обобщена функция. Приема резен от всеки сравним
// (`comparable`) вид данни и един член от такъв вид, и връща показалец към
// първото съвпадение с `v`  в `s`, или -1, ако не го намери.
...
// резен. В следващия пример ще видим
