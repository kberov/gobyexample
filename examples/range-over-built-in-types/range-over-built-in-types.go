...
func main() {
	...
	// получаваме следващото място от таблицата Уникод[^unicode].
	// Първата стойност е показалец за мястото в низа на
	// началният байт от следващия знак (`rune` – руна), а
	// втората е самият знак – `rune`. Вижте [Низове и
	// Руни](strings-and-runes), за повече подробности.
	// Тук обхождаме стойността, която връща ключа `я` от
	// картата `kvs`.
