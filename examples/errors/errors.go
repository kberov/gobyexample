...
func makeTea(arg int) error {
	if arg == 2 {
		...
		// Можем да обгърнем[^wrap] грешките в други грешки от по-високо
		// равнище, за да добавим _смисъл_[^context]. Най-простият начин да го
		// направим е с помощта на глагола `%w` в `fmt.Errorf`. Обгърнатите
		// грешки създават смислова логическа верига (А обгръща Б, която
		// обгръща В, и т.н.), която може да бъде проследявана с функции като
