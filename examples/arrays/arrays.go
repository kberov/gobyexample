...
// [резените](slices)[^slices] се срещат много по-често;
// поредиците са полезни в някои определени случаи, когато
...
// [^slices]: slice – резен (от поредица): поредица с променлива по време на изпълнение дължина
