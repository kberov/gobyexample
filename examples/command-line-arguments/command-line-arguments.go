...
// hello.go` `run` и `hello.go` са податки (входни данни, подадени от командния
// ред) на програмата `go`.
...
func main() {
	...
	// Резенът `os.Args` съдържа суровите данни, подадени на командния
	// ред[^sep]. Забележете, че първата стойност в резена е пълният пѫт до
	...
	// Можете да ползвате отделните податки като укажете мястото им в резена.
	arg := os.Args[3]
