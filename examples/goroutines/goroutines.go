...
// изпълнение.
// [^goroutine]: goroutine – гозадача. Измислена за езика Го дума, за да обозначи и разграничи вида нишки в този език от другите програмни езици – подзадача, изпълняваща се едновременно с главната.
