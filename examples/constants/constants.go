// Go поддържа _непроменливи_[^const] стойности от
// видовете за знак, низ, булева и числова стойности.
// [^const]: constant – непроменлива стойност, константна величина, константа
