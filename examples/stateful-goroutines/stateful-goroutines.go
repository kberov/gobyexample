// В предишния пример използвахме изрично заключване на данните с помощта на
// [превключвачи](mutexes), за да съгласуваме достъпа до споделено състояние
// между множество гозадачи. Друга възможност да постигнем същото е да
// използваме вградените възможности за съгласуване в езика чрез гозадачи и
// канали. Този подход, основан на канали е в съзвучие с представата на Го да
// се споделя памет чрез предаване на съобщения между гозадачите и едно парче
