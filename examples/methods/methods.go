...
// _методи_[^method].
// [^method]: method – способ; начин за извършване на определено действие, принадлежащ само на отделен вид данни; функция, принадлежаща само на отделен вид данни; метод
