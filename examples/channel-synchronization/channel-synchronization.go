...
// [^blocking_rcv]: blocking receive – спъващо (блокиращо) получаване. Такова получаване на данни, което спира изпълнението на главната нишка/гозадача на програмата.
