...
func main() {
	...
	// Това действие ни връща завършения хеш като резен от байтове.
	// Подаденият на `Sum` допълнителен резен от байтове може да се постави
